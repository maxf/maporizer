...
var _user$project$Types$Uri = function (a) {
	return {ctor: 'Uri', _0: a};
};
var _user$project$Types$XmlInstance = function (a) {
	return {ctor: 'XmlInstance', _0: a};
};

var _user$project$Main$naturalThings = function (xml) {
	return A2(_eeue56$elm_xml$Xml_Query$tags, 'way', xml);
};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		if (_p0._0.ctor === 'Ok') {
			var xml = A2(
				_elm_lang$core$Maybe$withDefault,
				_eeue56$elm_xml$Xml_Encode$null,
				_elm_lang$core$Result$toMaybe(
					_eeue56$elm_xml$Xml_Decode$decode(_p0._0._0)));
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						mapSource: _user$project$Types$XmlInstance(xml),
						message: 'OK'
					}),
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {mapSourceUrl: a, mapSource: b, message: c};
	});
var _user$project$Main$initialModel = A3(
	_user$project$Main$Model,
	_user$project$Types$Uri('http://localhost:3000/montpelier.xml'),
	_user$project$Types$XmlInstance(
		_eeue56$elm_xml$Xml$StrNode('')),
	'');
var _user$project$Main$SourceMapLoaded = function (a) {
	return {ctor: 'SourceMapLoaded', _0: a};
};
var _user$project$Main$fetchSourceMap = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$SourceMapLoaded,
...
var _user$project$Main$init = {
	...
	_0: _elm_lang$core$Native_Utils.update(
		...
		{message: 'Fetching XML'}),
	_1: _user$project$Main$fetchSourceMap(_user$project$Main$initialModel.mapSourceUrl)
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"SourceMapLoaded":["Result.Result Http.Error String"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
